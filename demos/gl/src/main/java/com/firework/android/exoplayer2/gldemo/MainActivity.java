 ...
 */
package com.firework.android.exoplayer2.gldemo;
...
public final class MainActivity extends Activity {
  ...
  private static final String ACTION_VIEW = "com.firework.android.exoplayer.gldemo.action.VIEW";
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    FrameLayout contentFrame = findViewById(R.id.fw_exo_content_frame);
