...
import static com.firework.android.exoplayer2.util.FileTypes.inferFileTypeFromResponseHeaders;
import static com.firework.android.exoplayer2.util.FileTypes.inferFileTypeFromUri;
...
import com.firework.android.exoplayer2.extractor.amr.AmrExtractor;
import com.firework.android.exoplayer2.extractor.flac.FlacExtractor;
import com.firework.android.exoplayer2.extractor.flv.FlvExtractor;
import com.firework.android.exoplayer2.extractor.jpeg.JpegExtractor;
import com.firework.android.exoplayer2.extractor.mkv.MatroskaExtractor;
import com.firework.android.exoplayer2.extractor.mp3.Mp3Extractor;
import com.firework.android.exoplayer2.extractor.mp4.FragmentedMp4Extractor;
import com.firework.android.exoplayer2.extractor.mp4.Mp4Extractor;
import com.firework.android.exoplayer2.extractor.ogg.OggExtractor;
import com.firework.android.exoplayer2.extractor.ts.Ac3Extractor;
import com.firework.android.exoplayer2.extractor.ts.Ac4Extractor;
import com.firework.android.exoplayer2.extractor.ts.AdtsExtractor;
import com.firework.android.exoplayer2.extractor.ts.DefaultTsPayloadReaderFactory;
...
import com.firework.android.exoplayer2.extractor.wav.WavExtractor;
import com.firework.android.exoplayer2.util.FileTypes;
import com.firework.android.exoplayer2.util.TimestampAdjuster;
 ...
 *             com.firework.android.exoplayer2.ext.flac.FlacExtractor} is used.
...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
   ...
   * by {@code com.firework.android.exoplayer2.ext.flac.FlacExtractor} instances if the FLAC extension
   * is being used.
   *
      ...
      synchronized (extensionLoaded) {
        ...
        try {
          ...
          boolean isFlacNativeLibraryAvailable =
              Boolean.TRUE.equals(
                  Class.forName("com.firework.android.exoplayer2.ext.flac.FlacLibrary")
                      .getMethod("isAvailable")
                      .invoke(/* obj= */ null));
          if (isFlacNativeLibraryAvailable) {
            extractorConstructor =
                Class.forName("com.firework.android.exoplayer2.ext.flac.FlacExtractor")
