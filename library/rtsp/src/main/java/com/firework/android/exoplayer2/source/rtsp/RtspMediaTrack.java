...
import static com.firework.android.exoplayer2.source.rtsp.RtpPayloadFormat.getMimeTypeFromRtpMediaType;
...
import static com.firework.android.exoplayer2.util.NalUnitUtil.NAL_START_CODE;
...
/* package */ final class RtspMediaTrack {
  ...
  public RtspMediaTrack(MediaDescription mediaDescription, Uri sessionUri) {
    checkArgument(mediaDescription.attributes.containsKey(SessionDescription.ATTR_CONTROL));
