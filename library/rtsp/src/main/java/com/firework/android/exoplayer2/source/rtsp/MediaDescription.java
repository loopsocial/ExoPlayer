...
/* package */ final class MediaDescription {
  ...
  public static final class Builder {
    ...
    public MediaDescription build() {
      try {
        ...
        checkState(attributes.containsKey(SessionDescription.ATTR_RTPMAP));
        RtpMapAttribute rtpMapAttribute =
            RtpMapAttribute.parse(castNonNull(attributes.get(SessionDescription.ATTR_RTPMAP)));
  ...
  public ImmutableMap<String, String> getFmtpParametersAsMap() {
    @Nullable String fmtpAttributeValue = attributes.get(SessionDescription.ATTR_FMTP);
