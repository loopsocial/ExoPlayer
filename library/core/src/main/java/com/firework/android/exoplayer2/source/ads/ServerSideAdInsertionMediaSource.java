...
import static com.firework.android.exoplayer2.source.ads.ServerSideAdInsertionUtil.getStreamPositionUs;
...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource
  ...
  public void setAdPlaybackState(AdPlaybackState adPlaybackState) {
    ...
    for (int i = adPlaybackState.removedAdGroupCount; i < adPlaybackState.adGroupCount; i++) {
      ...
      if (i < this.adPlaybackState.adGroupCount) {
        checkArgument(
            ServerSideAdInsertionUtil.getAdCountInGroup(adPlaybackState, /* adGroupIndex= */ i)
                >= ServerSideAdInsertionUtil
                .getAdCountInGroup(this.adPlaybackState, /* adGroupIndex= */ i));
      }
      if (adGroup.timeUs == C.TIME_END_OF_SOURCE) {
        checkArgument(
            ServerSideAdInsertionUtil.getAdCountInGroup(adPlaybackState, /* adGroupIndex= */ i) == 0);
      }
    }
    synchronized (this) {
  ...
  public MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator, long startPositionUs) {
    ...
    if (lastUsedMediaPeriod != null) {
      ...
      if (lastExistingPeriod != null
        ...
        long streamPositionUs = ServerSideAdInsertionUtil
  ...
  private static final class SharedMediaPeriod implements MediaPeriod.Callback {
    ...
    public boolean canReuseMediaPeriod(MediaPeriodId id, long positionUs) {
      ...
      long previousEndPositionUs =
          ServerSideAdInsertionUtil.getStreamPositionUs(
              ...
              adPlaybackState);
      long startPositionUs = ServerSideAdInsertionUtil
    ...
    private long getStreamPositionUsWithNotYetStartedHandling(
      ...
      return ServerSideAdInsertionUtil
          .getStreamPositionUs(positionUs, mediaPeriod.mediaPeriodId, adPlaybackState);
    }
