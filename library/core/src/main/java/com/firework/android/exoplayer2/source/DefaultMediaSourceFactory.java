...
import com.firework.android.exoplayer2.text.SubtitleDecoderFactory;
...
import com.firework.android.exoplayer2.text.SubtitleExtractor;
    ...
    private Supplier<MediaSourceFactory> maybeLoadSupplier(@C.ContentType int contentType) {
      ...
      try {
        ...
        switch (contentType) {
          case C.TYPE_DASH:
            clazz =
                Class.forName("com.firework.android.exoplayer2.source.dash.DashMediaSource$Factory")
          ...
          case C.TYPE_SS:
            clazz =
                Class.forName(
                        "com.firework.android.exoplayer2.source.smoothstreaming.SsMediaSource$Factory")
                    .asSubclass(MediaSourceFactory.class);
            mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
            break;
          case C.TYPE_HLS:
            clazz =
                Class.forName("com.firework.android.exoplayer2.source.hls.HlsMediaSource$Factory")
                    .asSubclass(MediaSourceFactory.class);
            mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
            break;
          case C.TYPE_RTSP:
            clazz =
                Class.forName("com.firework.android.exoplayer2.source.rtsp.RtspMediaSource$Factory")
                    .asSubclass(MediaSourceFactory.class);
