...
import static com.firework.android.exoplayer2.Player.DISCONTINUITY_REASON_AUTO_TRANSITION;
import static com.firework.android.exoplayer2.Player.DISCONTINUITY_REASON_INTERNAL;
import static com.firework.android.exoplayer2.Player.DISCONTINUITY_REASON_REMOVE;
import static com.firework.android.exoplayer2.Player.DISCONTINUITY_REASON_SEEK;
import static com.firework.android.exoplayer2.Player.EVENT_MEDIA_METADATA_CHANGED;
import static com.firework.android.exoplayer2.Player.EVENT_PLAYLIST_METADATA_CHANGED;
import static com.firework.android.exoplayer2.Player.EVENT_TRACK_SELECTION_PARAMETERS_CHANGED;
import static com.firework.android.exoplayer2.Player.MEDIA_ITEM_TRANSITION_REASON_AUTO;
import static com.firework.android.exoplayer2.Player.MEDIA_ITEM_TRANSITION_REASON_PLAYLIST_CHANGED;
import static com.firework.android.exoplayer2.Player.MEDIA_ITEM_TRANSITION_REASON_REPEAT;
import static com.firework.android.exoplayer2.Player.MEDIA_ITEM_TRANSITION_REASON_SEEK;
import static com.firework.android.exoplayer2.Player.PLAYBACK_SUPPRESSION_REASON_NONE;
import static com.firework.android.exoplayer2.Player.PLAY_WHEN_READY_CHANGE_REASON_USER_REQUEST;
import static com.firework.android.exoplayer2.Player.STATE_BUFFERING;
import static com.firework.android.exoplayer2.Player.STATE_ENDED;
import static com.firework.android.exoplayer2.Player.STATE_IDLE;
import static com.firework.android.exoplayer2.Player.TIMELINE_CHANGE_REASON_PLAYLIST_CHANGED;
import static com.firework.android.exoplayer2.Player.TIMELINE_CHANGE_REASON_SOURCE_UPDATE;
import static com.firework.android.exoplayer2.util.Assertions.checkNotNull;
import static com.firework.android.exoplayer2.util.Assertions.checkState;
...
import com.firework.android.exoplayer2.ExoPlayer.AudioOffloadListener;
import com.firework.android.exoplayer2.Player.Commands;
import com.firework.android.exoplayer2.Player.DiscontinuityReason;
import com.firework.android.exoplayer2.Player.EventListener;
import com.firework.android.exoplayer2.Player.Events;
import com.firework.android.exoplayer2.Player.Listener;
import com.firework.android.exoplayer2.Player.PlayWhenReadyChangeReason;
import com.firework.android.exoplayer2.Player.PlaybackSuppressionReason;
import com.firework.android.exoplayer2.Player.PositionInfo;
import com.firework.android.exoplayer2.Player.RepeatMode;
import com.firework.android.exoplayer2.Player.State;
import com.firework.android.exoplayer2.Player.TimelineChangeReason;
...
/* package */ final class ExoPlayerImpl {
  ...
  private PlaybackInfo maskTimelineAndPosition(
    ...
    MediaSource.MediaPeriodId newPeriodId =
        playingPeriodChanged ? new MediaSource.MediaPeriodId(periodPosition.first) : playbackInfo.periodId;
