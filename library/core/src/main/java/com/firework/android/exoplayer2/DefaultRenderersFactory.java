...
import com.firework.android.exoplayer2.audio.AudioCapabilities;
...
import com.firework.android.exoplayer2.audio.DefaultAudioSink;
import com.firework.android.exoplayer2.audio.MediaCodecAudioRenderer;
...
import com.firework.android.exoplayer2.metadata.MetadataRenderer;
import com.firework.android.exoplayer2.text.TextOutput;
import com.firework.android.exoplayer2.text.TextRenderer;
import com.firework.android.exoplayer2.trackselection.TrackSelector;
import com.firework.android.exoplayer2.video.MediaCodecVideoRenderer;
import com.firework.android.exoplayer2.util.Log;
import com.firework.android.exoplayer2.video.VideoRendererEventListener;
import com.firework.android.exoplayer2.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      Class<?> clazz = Class.forName("com.firework.android.exoplayer2.ext.vp9.LibvpxVideoRenderer");
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.firework.android.exoplayer2.ext.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz =
          Class.forName("com.firework.android.exoplayer2.ext.ffmpeg.FfmpegVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.firework.android.exoplayer2.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("com.firework.android.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              AudioRendererEventListener.class,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz =
          Class.forName("com.firework.android.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              AudioRendererEventListener.class,
